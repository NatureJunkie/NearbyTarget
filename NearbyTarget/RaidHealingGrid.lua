...
for i = 1, MAX_UNITS do
  ...
  for j = 1, 7 do
    ...
    btn:SetScript("OnClick", function(_, mouseButton)
      ...
      -- spell actions
      if     idx == 1 then RButton1()
      elseif idx == 2 then RButton2()
      elseif idx == 3 then RButton3()
      elseif idx == 4 then RButton4()
      elseif idx == 5 then RButton5()
      elseif idx == 6 then RButton6()
      elseif idx == 7 then RButton7() end
