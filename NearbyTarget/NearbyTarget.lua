...
for i = 1, MAX_ROWS do
  ...
  for j = 1, 7 do
    ...
    btn:SetScript("OnClick", function()
      ...
      if buttonIndex == 1 then Button1()
      elseif buttonIndex == 2 then Button2()
      elseif buttonIndex == 3 then Button3()
      elseif buttonIndex == 4 then Button4()
      elseif buttonIndex == 5 then Button5()
      elseif buttonIndex == 6 then Button6()
      elseif buttonIndex == 7 then Button7()
      end
    end)
