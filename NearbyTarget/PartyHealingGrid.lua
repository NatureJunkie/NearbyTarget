...
for i = 1, MAX_UNITS do
  ...
  for j = 1, 7 do
    ...
    btn:SetScript("OnClick", function(_, mouseButton)
      ...
      -- Cast per-button
      if     idx == 1 then PButton1()
      elseif idx == 2 then PButton2()
      elseif idx == 3 then PButton3()
      elseif idx == 4 then PButton4()
      elseif idx == 5 then PButton5()
      elseif idx == 6 then PButton6()
      elseif idx == 7 then PButton7() end
